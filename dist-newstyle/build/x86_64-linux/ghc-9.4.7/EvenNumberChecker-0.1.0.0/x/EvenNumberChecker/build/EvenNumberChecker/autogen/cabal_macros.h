...
/* package EvenNumberChecker-0.1.0.0 */
#ifndef VERSION_EvenNumberChecker
#define VERSION_EvenNumberChecker "0.1.0.0"
#endif /* VERSION_EvenNumberChecker */
#ifndef MIN_VERSION_EvenNumberChecker
#define MIN_VERSION_EvenNumberChecker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EvenNumberChecker */
...
#define CURRENT_COMPONENT_ID "EvenNumberChecker-0.1.0.0-inplace-EvenNumberChecker"
